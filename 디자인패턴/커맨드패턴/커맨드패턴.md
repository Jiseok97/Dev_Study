...
* 장점 
    * [Single Responsibility (단일 책임 원칙)](https://github.com/Jiseok97/Dev_Study/blob/master/%EB%94%94%EC%9E%90%EC%9D%B8%ED%8C%A8%ED%84%B4/SOLID.md)을 만족한다. Command 객체를 통해 **작업을 수행하는 객체**와 **작업을 호출하는 객체**를 나눌 수 있다.
    
    * [Open / Closed Principle (개방 / 폐쇄 원칙)](https://github.com/Jiseok97/Dev_Study/blob/master/%EB%94%94%EC%9E%90%EC%9D%B8%ED%8C%A8%ED%84%B4/SOLID.md)을 만족한다. 클라이언트의 코드를 수정하지 않고도 새로운 Command를 추가할 수 있다.
...
- 뭔가 알 것 같으면서도 아직은 정확하게 이해를 못한 것 같다..
- 조금 더 공부해 볼 필요가 있다..🥲
